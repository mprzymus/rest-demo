...
class VendorControllerTest extends AbstractRestControllerTest{
    ...
    @BeforeEach
    public void setUp() {
        vendorDTO_1 = new VendorDTO("Vendor 1", VendorController.URL + "/1");
        vendorDTO_2 = new VendorDTO("Vendor 2", VendorController.URL + "/2");
    }
    ...
    public void getVendorList() throws Exception {
        ...
        mockMvc.perform(get(VendorController.URL)
    ...
    public void getVendorById() throws Exception {
        ...
        mockMvc.perform(get(VendorController.URL + "/1")
                .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
    ...
    public void createNewVendor() throws Exception {
        ...
        mockMvc.perform(post(VendorController.URL)
                .contentType(MediaType.APPLICATION_JSON)
    ...
    public void updateVendor() throws Exception {
        ...
        given(vendorService.saveOrUpdateVendorByDTO(anyLong(), any())).willReturn(vendorDTO_1);

        mockMvc.perform(put(VendorController.URL + "/1")
                .contentType(MediaType.APPLICATION_JSON)
                .content(asJsonString(vendorDTO_1)))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.name", equalTo(vendorDTO_1.getName())));
    ...
    public void patchVendor() throws Exception {
        ...
        mockMvc.perform(patch(VendorController.URL + "/1")
                .contentType(MediaType.APPLICATION_JSON)
                .content(asJsonString(vendorDTO_1)))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.name", equalTo(vendorDTO_1.getName())));
    ...
    public void deleteVendor() throws Exception {
        mockMvc.perform(delete(VendorController.URL + "/1"))
                .andExpect(status().isOk());
